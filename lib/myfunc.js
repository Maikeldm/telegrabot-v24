...
import { proto, delay, getContentType } from 'baron-baileys-v2';
...
// Function moved to a single declaration at line 218
...
export const checkBandwidth = async () => {
    let ind = 0;
    let out = 0;
    const netstat = await import('node-os-utils').then(m => m.netstat);
    for (let i of await netstat.stats()) {
