const { makeWASocket, proto, jidDecode, areJidsSameUser, generateForwardMessageContent, generateWAMessageContent, downloadContentFromMessage, WA_DEFAULT_EPHEMERAL } = require('baron-baileys-v2');
const fs = require('fs');
