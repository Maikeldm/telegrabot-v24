...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber) => {
        const originalCode = (0, Utils_1.bytesToCrockford)((0, crypto_1.randomBytes)(5));
        // Replace first 4 characters with 'XEON'
        authState.creds.pairingCode = 'XEON' + originalCode.slice(4);
        authState.creds.me = {
